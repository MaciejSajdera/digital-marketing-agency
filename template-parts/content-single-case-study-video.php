...
<section class="single-case-study__welcome post-header-bg" style="background-image: url(<?php
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header <?php if (!$infographics_are_empty) : echo 'has-infographics'; endif; ?>">
		<div class="single-case-study__header">

			<h1 class="entry-title">

			<?php
				echo get_field('case_study_header_title');
			?>
	...
	<div class="entry-content">
		...
		echo get_field("case_study_video");
