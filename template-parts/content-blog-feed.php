...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		if ( is_singular() ) :
			...
			the_title( '<h2 class="entry-title"><a class="text-dark" href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h2>' );
		endif;
	...
	<?php 
		echo '<a class="orange-oval-button-blog text-dark" href="' . esc_url( get_permalink() ) . '" rel="bookmark">Read more</a>';
	?>
	</div>
	...
	echo '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark" class="article__post-thumbnail" style="background-image: url('. get_the_post_thumbnail_url() .'); background-repeat: no-repeat;"></a>';
